...
parser.add_argument(
    "--optim", default="sgd", help="Which optimizer to use (sgd or adam, default: sgd)"
)
parser.add_argument(
    "--trigger_label",
    type=int,
...
parser.add_argument(
    "--batchsize", type=int, default=64, help="Batch size to split dataset, default: 64"
)
parser.add_argument(
    "--learning_rate",
    type=float,
...
def main():
    ...
    train_data, test_data = load_init_data(
